...
export default function SubscribeSection() {
  return (
    <div className="flex flex-col items-center h-[70vh] justify-center mt-16 border  rounded-xl bg-red-400 py-10 ">
      ...
      {/* Additional Info */}
      <p className="text-2xl font-bold text-center mb-8 w-1/2 text-white">Subscribe to our newsletter for a weekly serving of recipes,cooking tips, and exclusive insights straight to your inbox. 
      .</p>
  ...
  />
  <button
    className="bg-black text-white py-2 px-4 rounded-full ml-[-1px] h-10"
  >
    Subscribe
  </button>
</div>
